...
export const providers: Provider[] = [
  ...
  },
  {
    ...
    reviews: [
      ...
      { author: 'Екатерина С.', text: 'ISPmanager 6 бесплатно — это огромный плюс! Панель удобная, всё интуитивно. Миграция с прошлого хостинга прошла без проблем.', rating: 5, date: '07 ноя 2025' },
      { author: 'Максим В.', text: 'Безлимитный трафик — то что нужно для highload проектов. За 2 года использования сбоев практически не было. Рекомендую!', rating: 5, date: '06 ноя 2025' },
      { author: 'Ольга Т.', text: 'Техподдержка 24/7 реально работает! Писала в 3 ночи — ответили за 10 минут. Помогли решить проблему с настройкой DNS.', rating: 5, date: '05 ноя 2025' },
      { author: 'Игорь П.', text: 'Пользуюсь VPS уже 3 года. Ни одного критичного сбоя за всё время. Uptime реально близок к 100%. Отличная стабильность!', rating: 5, date: '04 ноя 2025' },
      { author: 'Светлана К.', text: 'Нет тестового периода — пришлось сразу платить. Но качество того стоит. 20 лет на рынке внушают доверие.', rating: 4, date: '03 ноя 2025' },
      { author: 'Дмитрий Р.', text: 'NVMe диски действительно быстрые! База данных работает моментально. Цена средняя, но за качество не жалко платить.', rating: 5, date: '02 ноя 2025' },
      { author: 'Мария Н.', text: 'Бесплатная миграция — это спасение! Перенесли все сайты за день, всё работает отлично. Специалисты очень помогли.', rating: 5, date: '01 ноя 2025' },
  ...
  },
  {
    ...
    uptime30days: 99.85,
    reviews: [
      { author: 'Александр В.', text: 'Пользуюсь с 2023 года. Личный кабинет удобный, цены низкие. Техподдержка лояльная, могут дать пробный сервер и помочь с настройками. Очень доволен!', rating: 5, date: '08 ноя 2025' },
      { author: 'Дмитрий К.', text: 'Год с VPS от SmartApe — полёт нормальный, без падений. Поддержка отличная, все вопросы решались быстро. Было всего 2-3 обращения за год. Рекомендую!', rating: 5, date: '06 ноя 2025' },
      { author: 'Марина С.', text: 'Безлимитный хостинг действительно безлимитный! Разместила 12 сайтов на одном тарифе. За 145₽ это просто находка для стартапа.', rating: 5, date: '04 ноя 2025' },
      { author: 'Евгений Р.', text: 'Техподдержка отвечает медленно — несколько раз в сутки. Для новичков сложновато, почти всё настраиваешь сам. Зато цена низкая и uptime хороший.', rating: 3, date: '02 ноя 2025' },
