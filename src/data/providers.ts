...
export const providers: Provider[] = [
  ...
  },
  {
    ...
    reviews: [
      { author: 'Ольга В.', text: 'Отличный вариант для первого сайта! Цена смешная, всё понятно даже новичку. Установила WordPress за 5 минут — готовых образов куча!', rating: 5, date: '14 ноя 2024' },
      { author: 'Дмитрий К.', text: 'Дёшево, но для блога хватает с головой. Автобэкапы спасли меня дважды — случайно удалил файлы, восстановили за минуту.', rating: 5, date: '10 ноя 2024' },
      { author: 'Сергей Л.', text: 'Техподдержка отвечает долго — часа 2-3 ждал. Но за такую цену простить можно. Для некритичных проектов — норм.', rating: 3, date: '05 ноя 2024' },
      { author: 'Мария П.', text: 'Идеально для новичков! Панель простая, инструкции понятные. Поставила сайт на Joomla без проблем. Цена копеечная!', rating: 5, date: '01 ноя 2024' },
      { author: 'Александр Т.', text: 'За 150₽ в месяц — просто подарок! SSL бесплатный, автобэкапы работают. Единственный минус — нет выделенного IP.', rating: 4, date: '28 окт 2024' },
      { author: 'Наталья Ф.', text: 'Для интернет-магазина маловато будет — сайт тормозит при наплыве клиентов. Но для визитки или блога — отлично!', rating: 3, date: '22 окт 2024' },
      { author: 'Игорь Ч.', text: 'Больше 100 готовых CMS — выбрал Bitrix за пару кликов. Для стартапа самое то. Цена смешная, качество приемлемое.', rating: 4, date: '18 окт 2024' },
      { author: 'Елена Ш.', text: 'Техподдержка работает медленно, но зато вежливые и помогают. Для некритичных задач подойдёт. Цена радует!', rating: 4, date: '12 окт 2024' },
      { author: 'Виктор Э.', text: 'Самый дешёвый хостинг, что я находил. За свои деньги — отлично. Но для highload не годится — будет тормозить.', rating: 4, date: '07 окт 2024' },
      { author: 'Ирина Ю.', text: 'Автобэкапы — просто спасение! Случайно удалила базу данных, восстановили за 10 минут. За такую цену — супер!', rating: 5, date: '03 окт 2024' },
      { author: 'Павел А.', text: 'Производительность средненькая, но за 150₽ что ещё ожидать? Для портфолио или лендинга — идеально. Недорого и сердито!', rating: 4, date: '29 сент 2024' },
      { author: 'Светлана Б.', text: 'Для новичка — лучший выбор! Панель простая, всё интуитивно. Поставила Drupal за пару минут. Очень довольна!', rating: 5, date: '24 сент 2024' },
      { author: 'Андрей Г.', text: 'Цена низкая, но и производительность соответствующая. Для блога хватает, а вот магазин тормозит. Надо апгрейд.', rating: 3, date: '19 сент 2024' },
      { author: 'Ольга Д.', text: 'SSL бесплатно — это круто! Не надо заморачиваться с сертификатами. За 150₽ — просто подарок для старта.', rating: 5, date: '14 сент 2024' },
      { author: 'Максим Е.', text: 'Техподдержка тормозит, но в итоге помогли. Для некритичных проектов сойдёт. Цена самая адекватная на рынке!', rating: 4, date: '09 сент 2024' },
      { author: 'Татьяна Ж.', text: 'Готовые образы CMS — это то что надо для новичка! Выбрала PrestaShop, установился моментально. Супер за такие деньги!', rating: 5, date: '04 сент 2024' },
      { author: 'Сергей З.', text: 'Нет выделенного IP — пришлось докупать. Но в целом за свою цену хостинг отличный. Для стартапа подходит идеально.', rating: 4, date: '30 авг 2024' },
      { author: 'Наталья И.', text: 'Автобэкапы работают как часы! Дважды спасли проект. За 150₽ в месяц — просто находка. Рекомендую новичкам!', rating: 5, date: '25 авг 2024' },
      { author: 'Дмитрий К.', text: 'Производительность ограниченная — сайт подтормаживает. Но за такую цену нормально. Для блога или визитки — отлично!', rating: 3, date: '20 авг 2024' },
      { author: 'Елена Л.', text: 'Для первого сайта — идеально! Панель простая, поддержка помогает. SSL бесплатный — вообще красота. Очень довольна!', rating: 5, date: '15 авг 2024' },
      { author: 'Александр М.', text: 'Техподдержка отвечает долго, но цена компенсирует. За 150₽ больше ожидать и не стоит. Для старта — самое то!', rating: 4, date: '10 авг 2024' },
      { author: 'Виктория Н.', text: 'Более 100 CMS на выбор — нашла всё что нужно! Поставила OpenCart за минуту. За свои деньги — топ!', rating: 5, date: '05 авг 2024' },
      { author: 'Игорь О.', text: 'Цена низкая, качество приемлемое. Для highload не подойдёт, но для маленького проекта — в самый раз. Доволен!', rating: 4, date: '31 июля 2024' },
      { author: 'Марина П.', text: 'SSL бесплатно, автобэкапы включены — за 150₽ это просто подарок! Для новичков лучше не найти. Рекомендую!', rating: 5, date: '26 июля 2024' },
      { author: 'Сергей Р.', text: 'Производительность слабовата для магазина, но для блога хватает. Цена самая низкая на рынке. Буду апгрейдить позже.', rating: 3, date: '21 июля 2024' },
      { author: 'Ольга С.', text: 'Панель управления понятная даже чайнику! Поставила сайт на ModX за 5 минут. За такую цену — просто волшебство!', rating: 5, date: '16 июля 2024' },
      { author: 'Дмитрий Т.', text: 'Техподдержка медленная, но вежливая. За 150₽ не жалуюсь. Для стартового проекта — отличный вариант!', rating: 4, date: '11 июля 2024' },
      { author: 'Елена У.', text: 'Автобэкапы спасли проект после взлома! Всё восстановили быстро. За копейки такой сервис — это супер!', rating: 5, date: '06 июля 2024' },
      { author: 'Павел Ф.', text: 'Нет выделенного IP в базе — минус. Но за такую цену простительно. Для визитки или портфолио — идеально!', rating: 4, date: '01 июля 2024' },
      { author: 'Светлана Х.', text: 'Готовые CMS — это находка! Выбрала TYPO3, установилась за минуту. Для новичка — лучший хостинг. Цена смешная!', rating: 5, date: '26 июня 2024' },
      { author: 'Андрей Ц.', text: 'Производительность для больших нагрузок маловата, но для малых проектов — норм. Цена радует, будет что апгрейдить!', rating: 3, date: '21 июня 2024' },
      { author: 'Наталья Ч.', text: 'SSL бесплатный — это круто! Не надо покупать отдельно. За 150₽ такой набор — просто подарок судьбы!', rating: 5, date: '16 июня 2024' },
      { author: 'Игорь Ш.', text: 'Техподдержка работает медленно, но помогают. За такую цену претензий нет. Для старта бизнеса — самое то!', rating: 4, date: '11 июня 2024' },
      { author: 'Марина Щ.', text: 'Больше 100 готовых CMS — выбор огромный! Поставила phpBB за пару кликов. За свои деньги — лучший вариант!', rating: 5, date: '06 июня 2024' },
      { author: 'Сергей Э.', text: 'Цена низкая, но и производительность соответствующая. Для блога хватает, магазин тормозит. Надо будет переезжать.', rating: 3, date: '01 июня 2024' },
      { author: 'Ольга Ю.', text: 'Автобэкапы работают отлично! Дважды спасали сайт. За 150₽ в месяц это просто мечта для новичка!', rating: 5, date: '27 мая 2024' },
      { author: 'Дмитрий Я.', text: 'Для некритичных проектов — отлично! Цена копеечная, функционал базовый, но достаточный. Рекомендую новичкам!', rating: 4, date: '22 мая 2024' },
      { author: 'Елена А.', text: 'Панель простая и понятная. SSL бесплатный. Автобэкапы включены. За 150₽ — просто находка для старта!', rating: 5, date: '17 мая 2024' },
      { author: 'Александр Б.', text: 'Техподдержка тормозит, но за такую цену простительно. Для маленького проекта хватает с головой. Доволен!', rating: 4, date: '12 мая 2024' },
      { author: 'Виктория В.', text: 'Готовые образы CMS — это то что нужно новичку! Выбрала Magento, установилась моментально. Супер!', rating: 5, date: '07 мая 2024' },
      { author: 'Игорь Г.', text: 'Нет выделенного IP — пришлось докупать за 100₽. Но в целом за 250₽ это всё равно дёшево. Для старта — отлично!', rating: 4, date: '02 мая 2024' },
      { author: 'Марина Д.', text: 'Производительность ограниченная, но для блога хватает. Цена самая низкая. SSL бесплатно. Новичкам — рекомендую!', rating: 4, date: '27 апр 2024' },
      { author: 'Сергей Е.', text: 'За 150₽ — лучший хостинг для старта! Автобэкапы спасли проект дважды. Панель простая. Очень доволен!', rating: 5, date: '22 апр 2024' },
      { author: 'Ольга Ж.', text: 'Техподдержка работает медленно — ждал ответа 4 часа. Но за такую цену нормально. Для некритичных задач подойдёт!', rating: 3, date: '17 апр 2024' },
      { author: 'Дмитрий З.', text: 'Более 100 CMS — выбрал что нужно за минуту! SSL бесплатный, автобэкапы работают. За свои деньги — топ!', rating: 5, date: '12 апр 2024' },
      { author: 'Елена И.', text: 'Для первого сайта — идеально! Цена копеечная, панель понятная, поддержка помогает. Очень довольна выбором!', rating: 5, date: '07 апр 2024' },
      { author: 'Павел К.', text: 'Производительность для магазина слабовата, но для блога хватает. Цена радует. Буду переезжать когда проект вырастет!', rating: 4, date: '02 апр 2024' },
      { author: 'Светлана Л.', text: 'Автобэкапы — лучшая функция! Спасли сайт после неудачного обновления. За 150₽ это просто подарок!', rating: 5, date: '28 март 2024' }
    ]
  },
  {
    id: 3,
