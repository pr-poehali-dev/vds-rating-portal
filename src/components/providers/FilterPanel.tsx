...
export const FilterPanel = ({
  ...
  return (
    <div className={`bg-gradient-to-br from-card via-card to-accent/30 border-2 border-border rounded-xl sm:rounded-2xl p-2 sm:p-3 md:p-4 mb-3 sm:mb-4 shadow-xl relative overflow-hidden transition-all duration-700 ease-in-out ${isExpanded ? 'max-w-full' : 'max-w-xs sm:max-w-sm'}`}>
