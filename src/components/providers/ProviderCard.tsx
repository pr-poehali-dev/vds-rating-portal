...
export const ProviderCard = ({
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <Card 
        className={`group border-0 transition-all duration-300 hover-lift overflow-visible relative flex flex-col h-full ${
          isSelected ? 'shadow-lg shadow-primary/30 bg-[#1a1a1a]' : 'bg-[#1a1a1a] hover:shadow-xl'
        }`}
        style={{
          borderRadius: '2rem',
          clipPath: 'polygon(0% 2rem, 0% 0.5rem, 0.1rem 0.3rem, 0.3rem 0.1rem, 0.5rem 0%, 2rem 0%, calc(100% - 10.45rem) 0%, calc(100% - 10.45rem + 0.15rem) 0.05rem, calc(100% - 10.45rem + 0.3rem) 0.15rem, calc(100% - 10.45rem + 0.45rem) 0.3rem, calc(100% - 10.45rem + 0.6rem) 0.5rem, calc(100% - 10.45rem + 0.75rem) 0.75rem, calc(100% - 10.45rem + 0.9rem) 1rem, calc(100% - 10.45rem + 1rem) 1.3rem, calc(100% - 10.45rem + 1.1rem) 1.65rem, calc(100% - 10.45rem + 1.15rem) 2rem, calc(100% - 10.45rem + 1.15rem) calc(5.6rem - 2rem), calc(100% - 10.45rem + 1.1rem) calc(5.6rem - 1.65rem), calc(100% - 10.45rem + 1rem) calc(5.6rem - 1.3rem), calc(100% - 10.45rem + 0.9rem) calc(5.6rem - 1rem), calc(100% - 10.45rem + 0.75rem) calc(5.6rem - 0.75rem), calc(100% - 10.45rem + 0.6rem) calc(5.6rem - 0.5rem), calc(100% - 10.45rem + 0.45rem) calc(5.6rem - 0.3rem), calc(100% - 10.45rem + 0.3rem) calc(5.6rem - 0.15rem), calc(100% - 10.45rem + 0.15rem) calc(5.6rem - 0.05rem), calc(100% - 10.45rem + 0.27rem) calc(5.6rem + 0.13rem), calc(100% - 10.45rem + 0.42rem) calc(5.6rem + 0.28rem), calc(100% - 10.45rem + 0.59rem) calc(5.6rem + 0.41rem), calc(100% - 10.45rem + 0.78rem) calc(5.6rem + 0.52rem), calc(100% - 10.45rem + 0.98rem) calc(5.6rem + 0.6rem), calc(100% - 10.45rem + 1.19rem) calc(5.6rem + 0.65rem), calc(100% - 10.45rem + 1.4rem) calc(5.6rem + 0.67rem), calc(100% - 10.45rem + 1.61rem) calc(5.6rem + 0.65rem), calc(100% - 10.45rem + 1.82rem) calc(5.6rem + 0.6rem), calc(100% - 10.45rem + 2.02rem) calc(5.6rem + 0.52rem), calc(100% - 10.45rem + 2.21rem) calc(5.6rem + 0.41rem), calc(100% - 10.45rem + 2.38rem) calc(5.6rem + 0.28rem), calc(100% - 10.45rem + 2.53rem) calc(5.6rem + 0.13rem), 100% calc(5.6rem - 0.5rem), 100% calc(100% - 2rem), 100% calc(100% - 0.5rem), calc(100% - 0.1rem) calc(100% - 0.3rem), calc(100% - 0.3rem) calc(100% - 0.1rem), calc(100% - 0.5rem) 100%, calc(100% - 2rem) 100%, 2rem 100%, 0.5rem 100%, 0.3rem calc(100% - 0.1rem), 0.1rem calc(100% - 0.3rem), 0% calc(100% - 0.5rem), 0% calc(100% - 2rem))'
        }}
      >
